...
if(isset($_POST['submit']))
  {
	...
	$sql ="INSERT INTO Designations(name) VALUES(:name)";
...
<label class="col-sm-2 control-label">Designation name<span style="color:red">*</span></label>
<div class="col-sm-4">
