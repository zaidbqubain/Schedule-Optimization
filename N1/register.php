...
$sql ="INSERT INTO users(name,email, password, gender , designation, image,role,department_id)
VALUES(:name, :email, :password, :gender, :designation, :image, :role, :department_id)";

if($lastInsertId)
{
    // if($role == "student"){
$sql ="INSERT INTO students(id,department_id,designation, gpa)VALUES(:id, :department_id,:designation, :gpa)";
$query= $dbh -> prepare($sql);
$query-> bindParam(':id', $lastInsertId, PDO::PARAM_INT);
$query-> bindParam(':gpa', $gpa, PDO::PARAM_INT);
$query-> bindParam(':designation', $gender, PDO::PARAM_STR);
$query-> bindParam(':department_id', $departments, PDO::PARAM_INT);
$query->execute();
// }
...
<!--                          <div class="form-group">
                            ...
                            <option value="<?php echo $department['id']; ?>"><?php echo $department['departname']; ?></option>
							<?php } ?>
                            </select>
                            </div>
                            </div>
			               ...
			               <div class="form-group">
                            ...
                            <div class="col-sm-6">
                            <select name="gender" class="form-control" style="margin-bottom: 15px;" required>
                            <option value="">Select</option>
                            <option value="Freshman">Freshman</option>
                            <option value="Saphomore">Sophomore</option>
