...
$out = shell_exec("Rscript --verbose ML.R $user_id 2>&1");
						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading"> <h1>Student Recommendations:</h1></div>
...
$sql = "select name, email from users inner join kmeans on users.id = student_id where dept_id = $user_id";
