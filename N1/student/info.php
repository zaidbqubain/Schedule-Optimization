						...
						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading"> <h1>Assignment Information:</h1></div>
...
<?php
$sql = "SELECT * FROM assignments INNER JOIN roster ON class_id = assignments.course_id WHERE roster.student_id = $user_id";
...
{				?>
										<tr>
                                            ...
                                            <td><?php echo date('d-M-Y H:i:s',  strtotime($result->startdate));?></td>
                                            <td><?php echo date('d-M-Y H:i:s', strtotime($result->enddate));?></td>
