...
<?php
$sql = "SELECT EV.id, EV.student_id, EV.assignment_id, EV.event_start, EV.event_end, EV.status,EV.pct_complete,t1.assignmentname,t1.duration
			  from  events EV left join assignments t1 ON (t1.assignment_id =EV.assignment_id)
...
{				?>
										<tr>
                                            ...
                                            <?php if($result->status == 1)
                                                    {?>
                                                    <a href="update-assignments.php?confirm=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Incomplete the record')">Completed <i class="fa fa-check-circle"></i></a>
                                                    <?php } else {?>
                                                    <a href="update-assignments.php?unconfirm=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to completed the record')">Incomplete <i class="fa fa-times-circle"></i></a>
                                                    <?php } ?>
										...
										<td>
										<a href="edit-assignments.php?edit=<?php echo $result->id;?>" onclick="return confirm('Do you want to Edit');">&nbsp; <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;
										<a href="update-assignments.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to Delete');"><i class="fa fa-trash" style="color:red"></i></a>&nbsp;&nbsp;
										</td>
																				</tr>
										<?php $cnt=$cnt+1; }} ?>
