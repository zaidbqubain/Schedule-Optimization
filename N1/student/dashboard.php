...
global $dbh,$user_id;
 ...
 WHERE student_id = '$user_id' AND EV.status= '$flag' GROUP BY t1.course_id";
...
global $dbh,$user_id;
 $sql = "SELECT AVG( duration ) AS duration, AVG( UNIX_TIMESTAMP( event_end ) - UNIX_TIMESTAMP( event_start ) ) /60 AS actual, a.type, classname FROM (assignments AS a INNER JOIN events AS e ON a.assignment_id = e.assignment_id) inner join courses on a.course_id = courses.id WHERE student_id = '$user_id' GROUP BY a.type order by FIELD(a.type, 'Homework','Exam','Project','Lab')";
...
function getEvents(){
	global $dbh,$user_id;
 $sql = "SELECT avg(pct_complete) as pct_complete, e.event_start,courses.classname, a.type  FROM (assignments AS a INNER JOIN events AS e ON a.assignment_id = e.assignment_id) inner join courses on a.course_id = courses.id WHERE student_id = 1 GROUP BY year(e.event_start), month(e.event_start), day(e.event_start) ";
  ...
  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
                ...
                <div class="panel-heading"><h5 style="text-align: center;">My Dashboard</h5></div>
...
<div class="panel-body">
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                            <label for="AssignementTypes">Assignment Type:</label>
